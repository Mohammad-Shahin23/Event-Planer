...
class FlightList(APIView):
    ...
    def get_nearby_airport(self, event):
        ...
        url = f'https://airlabs.co/api/v9/nearby?lat={lat}&lng={lon}&distance=200&api_key=5211e0c0-a900-4455-a58b-29dffe567ac3'
    ...
    def get(self, request):
        ...
        if queryset.exists():
            ...
            url_going = f'https://airlabs.co/api/v9/schedules?dep_icao={airport_code}&arr_icao={nearest_ariport["icao_code"]}&api_key=5211e0c0-a900-4455-a58b-29dffe567ac3'
            url_back = f'https://airlabs.co/api/v9/schedules?dep_icao={nearest_ariport["icao_code"]}&arr_icao={airport_code}&api_key=5211e0c0-a900-4455-a58b-29dffe567ac3'
